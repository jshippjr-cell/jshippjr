...
- **`docs/` (the rest)** holds the decision/plan **archive**: `company-strategy.md`,
  `product-roadmap.md`, `market-research.md`, `relationship-strategy.md` (how the
  company becomes known and trusted by the people who commission music — the seats,
  rooms, cadence and CRM behaviour; inherits the CMO's positioning unchanged), the
