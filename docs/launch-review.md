...
`shell.py` + six route modules + the helper layer (`uploads`, `billing`, `delivery_ops`,
`opportunity_ops`), **9,133 → 2,326 lines, 251 → 65 routes.** What is left is the
application object plus seven small groups. Was:
