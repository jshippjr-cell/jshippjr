...
`shell.py` + eight route modules + the helper layer (`uploads`, `billing`,
`delivery_ops`, `opportunity_ops`), **9,133 → 2,004 lines, 251 → 51 routes.** What is left
is the application object plus five small groups. Was:
