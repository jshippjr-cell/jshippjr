...
def build_commercial_review(
    ...
    *, met: bool = True, version: int = 1,
) -> CommercialReview:
    """Project a Commercial Review from Campaign Intelligence + the estimation/proposals
    engines. Pure: no persistence, no duplicate copy of the campaign facts."""
    ci_view = ci_view or {}
    ...
    fee_low, fee_high = _price_band(estimate)
    ...
    return CommercialReview(
        ...
        terms=_producer_terms(opp, ci_fields, rounds, proposal.deposit_pct),
